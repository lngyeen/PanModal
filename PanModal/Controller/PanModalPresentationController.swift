...
open class PanModalPresentationController: UIPresentationController {
     ...
     */
    enum Constants {
        static let defaultDragIndicatorYOffset = CGFloat(8)
...
private extension PanModalPresentationController {
    ...
    func adjustPresentedViewFrame() {
        ...
        if ![shortFormYPosition, longFormYPosition].contains(panFrame.origin.y) {
            ...
            dragIndicatorView.frame.origin.y = presentedView.frame.origin.y - dragIndicatorYOffset // Constants.indicatorYOffset
        }
    ...
    func addDragIndicatorView(to view: UIView, on pinEdgeView: UIView) {
        ...
        dragIndicatorView.bottomAnchor.constraint(equalTo: pinEdgeView.topAnchor, constant: -dragIndicatorYOffset).isActive = true
...
private extension PanModalPresentationController {
    ...
    func adjust(toYPosition yPos: CGFloat, updateDragIndicatorView: Bool = false) {
        ...
        if updateDragIndicatorView {
            dragIndicatorView.frame.origin.y = presentedView.frame.origin.y - dragIndicatorYOffset
        }
...
private extension PanModalPresentationController {
    ...
    func addRoundedCorners(to view: UIView) {
        ...
        let maskedCorners = CACornerMask(rawValue: createMask(corners: [.topLeft, .topRight]))
